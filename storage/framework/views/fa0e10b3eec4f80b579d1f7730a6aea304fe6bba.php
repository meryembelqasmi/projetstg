                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id="ajouterForm">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="typeCourrier" name="typeCourrier">
                                                        <option value="">Sélectionner le type de courrier</option>
                                                        <option value="archive">Archive</option>
                                                        <option value="courrier_travail">Courrier de travail</option>
                                                    </select>
                                                    <div id="courrierTravailFields" style="display:none;">
                                                        <input type="date" class="form-control" id="dateAffectation" name="dateAffectation" placeholder="Entrer la date d'affectation...">
                                                        <input type="date" class="form-control" id="datePrecis" name="datePrecis" placeholder="Entrer la date précise...">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
